...
> This section is from the FreeBSD forum, by mrclksr. The original is located at <https://forums.freebsd.org/threads/wheres-bsd-libc-documentation.63107/>.
...
Run the script to find the PDF document in the same path folder. For ready-made documents, see.
