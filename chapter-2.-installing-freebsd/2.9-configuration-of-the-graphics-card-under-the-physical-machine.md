...
> **Troubleshooting:**
>
>**If prompted with `/usr/ports/xxx no such xxx` path not found, please fetch portsnap first: `portsnap fetch extract`. portsnap change source problem please visit previous article.**
